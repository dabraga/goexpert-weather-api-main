...
- [x] Deverá ser realizado o [deploy no Google Cloud Run](https://goexpert-weather-api-main-534292889217.us-central1.run.app).
...
- [x] Deploy realizado no Google Cloud Run (free tier) e [endereço ativo para ser acessado](https://goexpert-weather-api-main-534292889217.us-central1.run.apprun.app).
